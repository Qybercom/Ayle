(function (global) {
	...
	AyleBootstrap.prototype.Init = function (element, config) {
		...
		if (mediaProviderConfig || (config.Playlist && config.Playlist.Items && config.Playlist.Items.length)) {
